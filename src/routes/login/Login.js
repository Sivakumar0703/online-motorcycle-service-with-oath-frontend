...
const Login = () => {
  ...
  async function login() {
    ...
    try {
      ...
      console.log("after storing", localStorage.getItem("user"));
    ...
    <div className="row login-page col-12">
      <div className="form col-md-6 bs mt-3" style={{ borderRadius: "5px" }}>
        ...
        <div className="btn-group">
          <button className="btn btn-primary mb-3 mt-3" onClick={login}>
            LOGIN
          </button>
          <button
            className="btn btn-danger mb-3 mt-3"
            onClick={() => demoLogin("admin@moto.com")}
          >
            ADMIN
          </button>
          <button
            className="btn btn-success mb-3 mt-3"
            onClick={() => demoLogin("guest@moto.com")}
          >
            GUEST
          </button>
        </div> <br/>
        <a className="no-account ml-2" href="/signup">
          {" "}
